...
const featureList = [
  {
    ...
    desc: "Our powerful steam extraction penetrates deep to remove stubborn dirt, allergens, and dust mites, ensuring a thorough cleanse.",
  },
  {
    icon: "🌱",
    title: "Eco-Friendly & Safe",
    desc: "We care for your family and the planet by using biodegradable, non-toxic cleaning solutions that are gentle yet effective.",
  },
  {
    icon: "🧽",
    title: "Advanced Stain Removal",
    desc: "Say goodbye to tough stains like wine, coffee, pet accidents, and more with our specialized treatment.",
  },
  {
    icon: "💨",
    title: "Rapid Drying Technology",
    desc: "Our state-of-the-art equipment reduces drying time significantly, so you can enjoy your refreshed carpets sooner.",
  },
  {
    icon: "🌸",
    title: "Odor Neutralization",
    desc: "We eliminate unpleasant odors at the source, leaving your space smelling fresh and inviting.",
  },
];
...
const ServicePage = ({ services }) => {
  ...
  // Sanitize description text for meta description (strip HTML tags)
  const metaDescription = service.description
    ? service.description.replace(/(<([^>]+)>)/gi, "").slice(0, 160)
    : `Learn more about our ${service.name} carpet cleaning service.`;
  ...
  return (
    <>
      ...
      >
        ...
        <section aria-labelledby="trust-us-heading">
          <h2
            id="trust-us-heading"
            style={{
              color: accentColor,
